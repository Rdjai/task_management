        ...
        <footer className="bg-amber-200 text-gray-800 py-10 px-4">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                <div className="flex flex-col items-start">
                    <h2 className="text-2xl font-extrabold mb-2">Zore App</h2>
                    <p className="text-gray-700 max-w-xs">
                        Eat. Watch. Enjoy. Delicious food and fun reels at your fingertips.
                    </p>
                </div>
                ...
                <div className="flex gap-4 text-gray-700">
                    <a href="#" className="hover:text-red-500 transition"><FaInstagram size={20} /></a>
                    <a href="#" className="hover:text-red-500 transition"><FaFacebookF size={20} /></a>
                    <a href="#" className="hover:text-red-500 transition"><FaTwitter size={20} /></a>
                </div>
            ...
            <div className="border-t border-gray-300 mt-8 pt-4 text-center text-gray-600 text-sm">
                &copy; {new Date().getFullYear()} Zore App. All rights reserved.
            </div>
        </footer>
    );
};
